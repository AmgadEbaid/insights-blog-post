...
export function PostCard({ post }: { post: post }) {
  ...
  return (
    <div>
      <div className=" my-10 pb-10 border-b border-gray-100 md">
    ...
    height={20}
  />
              <Link href={`/author/${post.user.id}/home`}>
                <h1 className="text-sm text-[#242424] font-normal hover:underline  hover:underline-offset-1">
            ...
            <div className="flex flex-row gap-2">
              <div className="w-3/4">
                <h1 className="mb-1 leading-tight lg:leading-normal font-marat-sans text-[#242424] text-xl font-extrabold md:text-2xl">
                  {post.titile}
                </h1>
                <p className=" text-base leading-5 text-[#6B6B6B]">
                  {post.description}
                </p>
